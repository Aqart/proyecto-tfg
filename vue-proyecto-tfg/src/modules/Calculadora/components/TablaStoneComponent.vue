<template>
  <div class="flex flex-col gap-3">
    ...
    <form @submit.prevent="handleSubmit" class="flex flex-col gap-3">
      ...
      <label for="terminacion"
        class="block mb-2 text-xl font-medium first-letter:uppercase text-shadow text-stoneBackground-3"
      >
        Terminación
      </label>
      <ul class="items-center w-full text-sm text-secondary bg-stoneBackground-2 bg-opacity-50 border border-stone border-opacity-50 rounded-lg sm:flex">
          <li class="w-full border-b border-stone border-opacity-50 sm:border-b-0 sm:border-r">
              <div class="flex items-center ps-3">
                  <input id="soloCortado" type="radio" value="10" name="terminacion" class="accent-stoneBackground-5 w-4 h-4 text-stone bg-stone border-stoneBackground-5">
                  <label for="soloCortado" class="w-full py-3 ms-2 text-sm font-medium text-secondary">Solo cortado</label>
              </div>
          </li>
          <li class="w-full border-b border-stone border-opacity-50 sm:border-b-0 sm:border-r">
              <div class="flex items-center ps-3">
                  <input id="apomazado" type="radio" value="20" name="terminacion" class="accent-stoneBackground-5 w-4 h-4 text-stone bg-stone border-stoneBackground-3">
                  <label for="apomazado" class="w-full py-3 ms-2 text-sm font-medium text-secondary">Apomazado</label>
              </div>
          </li>
          <li class="w-full border-b border-stone border-opacity-50 sm:border-b-0 sm:border-r">
              <div class="flex items-center ps-3">
                  <input id="envejecido" type="radio" value="30" name="terminacion" class="accent-stoneBackground-5 w-4 h-4 text-stone bg-stone border-stoneBackground-3">
                  <label for="envejecido" class="w-full py-3 ms-2 text-sm font-medium text-secondary">Envejecido</label>
              </div>
          </li>
          <li class="w-full">
              <div class="flex items-center ps-3">
                  <input id="abujardado" type="radio" value="40" name="terminacion" class="accent-stoneBackground-5 w-4 h-4 text-stone bg-stone border-stoneBackground-3">
                  <label for="abujardado" class="w-full py-3 ms-2 text-sm text-seconsary">Abujardado</label>
              </div>
          </li>
      </ul>
    ...
    <ul class="grid w-full gap-6 md:grid-cols-2">
        <li>
          <input type="radio" id="embalado" name="embalaje" value="20" class="hidden peer" required />
          <label for="embalado" c
        ...
        <li>
            <input type="radio" id="hosting-big" name="embalaje" value="hosting-big" class="hidden peer">
