  ...
  <table class="w-full text-sm text-left rtl:text-right text-secondary-500">
          ...
          <thead class="text-xs text-secondary uppercase bg-primary sticky top-0">
            <tr>
              ...
              <th v-for="(head, index) in tableHead[0]" :key="index" scope="col" class="px-6 py-3">{{ index }}</th>
          ...
          <tbody class="h-96 overflow-y-auto">
            ...
            >
              ...
              <td v-for="el in body" :key="el" class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900 dark:text-gray-100">{{ el }}</div>
              </td>
              <td class="px-6 py-4">
                <router-link
