<template>
  <ModalComponent :showModal="showModal" :title="'Añadir un nuevo consumible'">
    <form @submit.prevent="handleSubmit" class="p-10">
      <label for="nombre" class="block mb-2 text-xl font-medium text-gray-900"> Nombre </label>
      <input
      ...
      <label for="precio" class="block mb-2 text-xl font-medium text-gray-900"> Precio </label>
      <input
